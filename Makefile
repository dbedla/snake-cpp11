...
cpp11: main.o
	g++ -lboost_thread obj/main.o obj/CPoint.o obj/key_handler.o obj/frame.o obj/snake.o obj/cmovesnake.o obj/clogger.o obj/CColisionDetector.o obj/CBasicWall.o -o bin/snake

main.o: src/main.cpp
	g++ -std=c++0x -c -g src/main.cpp -o obj/main.o 
	g++ -std=c++0x -c -g src/CPoint.cpp -o obj/CPoint.o
	g++ -std=c++0x -c -g src/key_handler.cpp -o obj/key_handler.o -lncurses
